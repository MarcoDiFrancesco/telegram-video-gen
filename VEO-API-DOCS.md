...
Optional. A Veo generated input video to extend in length. The input video is subject to the following limitations:
...
You can provide either a bytesBase64Encoded string that encodes a video or a gcsUri string URI to a Cloud Storage bucket location.
